...
export const siteConfig: SiteConfig = {
	...
	description:
		"Elysia 是一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。该主题融合了现代 Web 技术栈，提供了丰富的功能模块和高度可定制的界面，让您能够轻松打造出专业且美观的个人博客网站。",
	keywords: [
		"Elysia",
		"Fuwari",
		"Astro",
	...
	navbarLogo: {
		...
		value: "/assets/images/t1.jpg",
		alt: "🍀",
	},
	navbarTitle: "Nuyoch", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
	navbarWidthFull: false, // 全宽导航栏，导航栏是否占满屏幕宽度，true：占满，false：不占满

	// 站点开始日期，用于统计运行天数
	siteStartDate: "2026-02-11", // 请修改为你的站点实际开始日期，格式：YYYY-MM-DD

	// bangumi配置
	bangumi: {
		userId: "1212300", // 在此处设置你的Bangumi用户ID
	},
	...
	backgroundWallpaper: {
		...
		src: {
			...
			// desktop: "/assets/images/爱的奇迹1.png",
			// desktop: "/assets/images/一如初见2.png",
			desktop: "/assets/images/a1.jpg",
			// 移动背景图片
			// mobile: "/assets/images/m3.webp",
			mobile: "/assets/images/a2.png",
		},
